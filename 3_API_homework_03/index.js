...
const createCard = (img, author, isLiked) => {
    return `
        <div class="wrapper">
            <img id="image" src=${img} alt="randomImage">
            <div class="img-data">
                <span id="author">${author}</span>
                <svg stroke="black" fill=${isLiked ? "red" : "white"}  width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
document.body.insertAdjacentHTML("beforeend",
    createCard(randomPhoto.urls.small, `${randomPhoto.user.first_name} ${randomPhoto.user.last_name}`, randomPhoto.liked_by_user));
