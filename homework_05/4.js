...
const productWithPics = products.filter((product) => product.hasOwnProperty("photos"));
// хотя на практике структура продактов скорее всего будет одинаковой (у всех будет свойство photos, но с пустым
// массивом где не картинок). в таком случае, будет фильтровать по product.photos.length !== 0.
